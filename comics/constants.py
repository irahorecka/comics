...
COMICS_CLASS = (
    ...
    api.bfgf_syndrome, api.big_nate, api.big_nate_first_class, api.big_top, api.bill_bramhall, api.bird_and_moon, api.birdbrains,
    api.bleeker_the_rechargeable_dog, api.bliss, api.bloom_county, api.bloom_county_2019, api.bo_nanas, api.bob_gorrell,
    api.bob_the_angry_flower, api.bob_the_squirrel, api.boomerangs, api.bottom_liners, api.bound_and_gagged, api.bozo,
    api.breaking_cat_news, api.brevity, api.brewster_rockit, api.brian_mcfadden, api.broom_hilda, api.buckles, api.bully,
    api.buni, api.calvin_and_hobbes, api.calvin_and_hobbes_en_espanol, api.catana_comics, api.cathy,
    ...
    api.cleats, api.close_to_home, api.compu_toon, api.cornered, api.cow_and_boy, api.cowtown, api.crabgrass, api.crankshaft, api.crumb,
    api.cul_de_sac, api.curses, api.daddys_home, api.dana_summers, api.dark_side_of_the_horse, api.day_by_dave, api.deep_dark_fears,
    api.deflocked, api.diamond_lil, api.dick_tracy, api.dinosaur_comics, api.dog_eat_doug,
    api.dogs_of_c_kennel, api.domestic_abuse, api.don_brutus, api.doodle_for_food, api.doodle_town, api.doonesbury, api.drabble,
    api.drew_sheneman, api.edge_city, api.eek, api.el_cafe_de_poncho, api.emmy_lou, api.endtown,
    ...
    api.freshly_squeezed, api.frog_applause, api.furbabies, api.g_man_webcomics, api.garfield, api.garfield_classics, api.garfield_en_espanol,
    ...
    api.jim_morin, api.joe_heller, api.joel_pett, api.joey_weatherford, api.john_deering, api.jumpstart, api.junk_drawer, api.justo_y_franco,
    ...
    api.las_hermanas_stone, api.last_kiss, api.laughing_redhead_comics, api.lay_lines, api.learn_to_speak_cat, api.legends_in_the_heights, api.liberty_meadows,
    ...
    api.moderately_confused, api.momma, api.monty, api.monty_diaros, api.mother_goose_and_grimm, api.motley, api.mr_lowe, api.mutt_and_jeff,
    ...
    api.over_the_hedge, api.overboard, api.overboard_en_espanol, api.ozy_and_millie, api.pat_oliphant, api.peanuts,
    ...
    api.rose_is_rose, api.rosebuds, api.rosebuds_en_espanol, api.rubes, api.rudy_park, api.sarahs_scribbles,
    api.saturday_morning_breakfast_cereal, api.savage_chickens, api.scary_gary, api.scenes_from_a_multiverse, api.scott_stantis,
    api.shen_comix, api.shermans_lagoon, api.shirley_and_son, api.shoe, api.sketchshark_comics, api.skin_horse,
    ...
    api.swan_eaters, api.sweet_and_sour_pork, api.sylvia, api.tank_mcnamara, api.tarzan, api.tarzan_en_espanol, api.ted_rall, api.ten_cats,
    ...
    api.too_much_coffee_man, api.trucutu, api.truth_facts, api.tutelandia, api.two_party_opera, api.ufo, api.underpants_and_overbites,
